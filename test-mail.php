    ...
    <div class="card">
      ...
      <div style="margin-top:22px;padding-top:16px;border-top:1px solid var(--border);">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
          <a href="test-mail.php?key=<?= urlencode($providedKey) ?>&send=1&host=seasshipping.com&port=25&enc=none" class="btn" style="background:#16a34a;font-size:12px;padding:7px 14px;">⚡ Plesk: seasshipping.com : 25</a>
          <a href="test-mail.php?key=<?= urlencode($providedKey) ?>&send=1&host=cp1.accu20.com&port=25&enc=none" class="btn btn-secondary" style="font-size:12px;padding:7px 12px;">cp1.accu20.com : 25</a>
          <a href="test-mail.php?key=<?= urlencode($providedKey) ?>&send=1&host=smtp.gmail.com&port=587&enc=tls" class="btn btn-secondary" style="font-size:12px;padding:7px 12px;">smtp.gmail.com : 587</a>
